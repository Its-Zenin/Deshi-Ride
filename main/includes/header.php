<header>
    ...
    .navbar-brand img{
        margin-left: -110px; /* adjust this value (e.g., -30px, -40px) for more left */
    }
     .navbar-brand img{

        margin-top: -20px;
     }
    /* If you want navbar to touch edges (no padding) */
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">
                    <img src="assets/images/image.png" alt="Car Rental Logo">
                </a>
